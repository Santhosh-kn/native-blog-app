...
/**
 * Plugin validation tests for FirebaseGoogleAuth.
 *
...
describe('Native Code', function () {
    it('has Android Kotlin file', function () {
        $kotlinFile = $this->pluginPath . '/resources/android/FirebaseGoogleAuthFunctions.kt';
    ...
    it('has iOS Swift file', function () {
        $swiftFile = $this->pluginPath . '/resources/ios/FirebaseGoogleAuthFunctions.swift';

        expect(file_exists($swiftFile))->toBeTrue();

        $content = file_get_contents($swiftFile);
        expect($content)->toContain('enum FirebaseGoogleAuthFunctions');
        expect($content)->toContain('BridgeFunction');
    });
...
describe('PHP Classes', function () {
    it('has service provider', function () {
        $file = $this->pluginPath . '/src/FirebaseGoogleAuthServiceProvider.php';
    ...
    it('has facade', function () {
        $file = $this->pluginPath . '/src/Facades/FirebaseGoogleAuth.php';
        expect(file_exists($file))->toBeTrue();
    ...
    it('has main implementation class', function () {
        $file = $this->pluginPath . '/src/FirebaseGoogleAuth.php';
        expect(file_exists($file))->toBeTrue();
