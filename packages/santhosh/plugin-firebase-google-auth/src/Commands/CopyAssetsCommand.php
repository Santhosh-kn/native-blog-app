...
namespace Santhosh\FirebaseGoogleAuth\Commands;

use Native\Mobile\Plugins\Commands\NativePluginHookCommand;

/**
 * Copy assets hook command for FirebaseGoogleAuth plugin.
 *
...
class CopyAssetsCommand extends NativePluginHookCommand
{
    ...
    protected $description = 'Copy assets for FirebaseGoogleAuth plugin';
    ...
    protected function copyAndroidAssets(): void
    {
        ...
        $this->info('Android assets copied for FirebaseGoogleAuth');
    }
    ...
    protected function copyIosAssets(): void
    {
        ...
        $this->info('iOS assets copied for FirebaseGoogleAuth');
    }
}